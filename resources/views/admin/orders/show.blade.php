    ...
    <div class="order-details">
        ...
        <div class="order-info">
            ...
            <div class="info-section">
                ...
                <p><strong>Стоимость:</strong> {{ number_format($order->total_cost, 0, ',', ' ') }} ₽</p>
            ...
            <div class="info-section">
                ...
                <form action="{{ route('admin.orders.update-status', $order) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="admin_notes" id="admin_notes" class="form-control" rows="3" style="min-height: 100px;">{{ $order->admin_notes }}</textarea>
                    </div>
        ...
        <div class="chat-section">
            ...
            <div class="chat-messages" id="messages-{{ $order->id }}">
                @foreach($order->messages()->with('user')->orderBy('created_at')->get() as $message)
